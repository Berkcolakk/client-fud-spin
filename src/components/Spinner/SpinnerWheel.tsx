...
const SpinnerWheel = () => {
    ...
    /* eslint-disable */
    return (
        <div className='lg:flex sm:block items-start justify-center px-4 p-4 w-full bg-white border border-gray-200 rounded-lg  dark:bg-gray-900 dark:border-gray-700'>
